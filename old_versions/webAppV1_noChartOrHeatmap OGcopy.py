...
try:
    # usage_data = pd.read_csv("home\energy_usage_daynames.csv")
    # usage_data = pd.read_csv("C:\Users\dimil\Documents\workspace-home\home\energy_usage_daynames.csv")
    usage_data = pd.read_csv("C:\\Users\\dimil\\Documents\\workspace-home\\home\\energy_usage_daynames.csv")
...
def handle_input(user_input):
    # Use the logic from the main() function to process the user input and return the chatbot's response
    response = handle_complex_question(user_input, appliance_data)
    return response
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
def handle_input():
    while True:
        ...
        # ...
            ...
            # ... (your existing code for generating a chart)
            return "Chart not supported in the web app."

        elif user_input == "heatmap":
            # ... (your existing code for generating a heatmap)
            return "Heatmap not supported in the web app."
...
# Finally, run the Flask web app by running the app.py file:
