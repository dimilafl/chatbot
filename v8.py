...
#In this updated code, I added error handling using try-except blocks to catch potential issues with loading 
#the energy usage data or fitting the linear regression model. 
#If there are any issues, the code will print an error message and exit the program.

#This error handling will help ensure that the 
#chatbot runs smoothly and provides helpful error messages to the user if any issues occur.
